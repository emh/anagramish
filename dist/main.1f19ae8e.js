...
},{}],"words.mjs":[function(require,module,exports) {
"use strict";
...
function renderLetter(letter, classes) {
  ...
  div.className = ['letter'].concat(_toConsumableArray(classes)).join(' ');
...
function render(state) {
  ...
  state.words.forEach(function (w, y) {
    return w.forEach(function (l, x) {
      var colorClass = startWord.indexOf(l) !== -1 ? 'start' : endWord.indexOf(l) !== -1 ? 'end' : '';
      var activeClass = x === state.position.x && y === state.position.y ? 'active' : '';
      renderLetter(l, [colorClass, activeClass]);
    });
  });
}
function init(pairs) {
  var pair = choosePair(pairs).split(',');
...
Promise.all([loadFile(_pairs.default)]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 1),
    pairs = _ref2[0];
  var state = init(pairs);
  render(state);
...
},{"./pairs.txt":"pairs.txt","./words.mjs":"words.mjs"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
